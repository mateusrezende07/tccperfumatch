...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Y EDT</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Y EDT.jfif">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Dia • Trabalho • Uso diário</p>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Fresco frutado e leve, transmite juventude, limpeza e energia casual.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Dior Sauvage EDT</li>
        <li>Versace Dylan Blue</li>
      </ul>

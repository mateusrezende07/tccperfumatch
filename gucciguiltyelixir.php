...
// PERFUME
$perfume_nome = "Gucci Guilty Elixir";
...
<head>
<meta charset="UTF-8">
<title>Gucci Guilty Elixir</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Gucci Guilty Elixir</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Gucci Guilty Elixir.jfif">
    ...
    <div class="bloco">
      ...
      <h3>Preço</h3>
      <div class="preco">R$ 1000 – R$ 1400</div>
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Mais intenso e encorpado, transmite luxo e presença forte.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>YSL Y Le Parfum</li>
        <li>Dior Sauvage Elixir</li>
      </ul>

...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Invictus Victory</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Invictus Victory.avif">
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Doce com baunilha e frescor, transmite energia e sedução.
      </p>

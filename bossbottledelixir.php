...
// PERFUME
$perfume_nome = "Boss Bottled Elixir";
...
<head>
<meta charset="UTF-8">
<title>Boss Bottled Elixir</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Boss Bottled Elixir</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Boss Bottled Elixir.jfif">
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Amadeirado intenso e sofisticado, transmite poder e elegância.
      </p>

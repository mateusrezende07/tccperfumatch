...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Montblanc Legend</h2>

  <div class="perfume-detalhe">

    <!-- ESQUERDA -->
    <div class="bloco">
      <img class="logo-marca" src="/perfumatch/uploads/marcas/montblanc.png">
      <img class="img-perfume" src="/perfumatch/uploads/Montblanc Legend.jfif">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Dia • Trabalho</p>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Aromático doce e limpo, transmite juventude e conforto.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Abercrombie Fierce</li>

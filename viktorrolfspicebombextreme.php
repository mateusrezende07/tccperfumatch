...
// PERFUME
$perfume_nome = "Spicebomb Extreme";
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Spicebomb Extreme</h2>

  <div class="perfume-detalhe">

    <!-- ESQUERDA -->
    <div class="bloco">
      <img class="logo-marca" src="/perfumatch/uploads/marcas/viktor.png">
      <img class="img-perfume" src="/perfumatch/uploads/Spicebomb Extreme.jfif">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Frio • Noite</p>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Especiado doce intenso, transmite calor e presença forte.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Spicebomb Infrared</li>
        <li>Spicebomb Night Vision</li>
      </ul>

...
// PERFUME
$perfume_nome = "Le Male Le Parfum";
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Le Male Le Parfum</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Le Male Le Parfum.png">
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        O Le Male Le Parfum transmite elegância intensa, doçura especiada e sofisticação envolvente, com uma presença marcante e sedutora ideal para noites especiais.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Oumini Optimum</li>

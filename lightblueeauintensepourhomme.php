...
// PERFUME
$perfume_nome = "Light Blue Intense Pour Homme";
...
<head>
<meta charset="UTF-8">
<title>Light Blue Intense Pour Homme</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Light Blue Intense Pour Homme</h2>

  <div class="perfume-detalhe">

    <!-- ESQUERDA -->
    <div class="bloco">
      <img class="logo-marca" src="/perfumatch/uploads/marcas/dolcegabbana.png">
      <img class="img-perfume" src="/perfumatch/uploads/lightblueintense.webp">
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Cítrico aquático intenso, transmite frescor gelado e sensação de verão.
      </p>

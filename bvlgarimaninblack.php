...
// PERFUME
$perfume_nome = "Bvlgari Man in Black";
...
<head>
<meta charset="UTF-8">
<title>Bvlgari Man in Black</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Bvlgari Man in Black</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Bvlgari Man in Black.jfif">
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Doce quente com rum e especiarias, transmite intensidade e sensualidade.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Man in Black Parfum</li>

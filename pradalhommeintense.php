...
// PERFUME
$perfume_nome = "Prada L’Homme Intense";
...
<head>
<meta charset="UTF-8">
<title>Prada L’Homme Intense</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Prada L’Homme Intense</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Prada L’Homme Intense.jfif">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Noite • Eventos formais • Encontros • Clima frio • Ambientes elegantes</p>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        O Prada L’Homme Intense transmite profundidade, elegância escura e sofisticação intensa, com uma aura envolvente e luxuosa — perfeito para noites marcantes e ambientes refinados.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Elegant Intense</li>
        <li>Black Iris</li>
      </ul>

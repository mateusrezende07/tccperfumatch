...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Dior Homme 2020</h2>

  <div class="perfume-detalhe">

    <!-- ESQUERDA -->
    <div class="bloco">
      <img class="logo-marca" src="/perfumatch/uploads/marcas/dior.png">
      <img class="img-perfume" src="/perfumatch/uploads/Dior Homme 2020.webp">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Dia • Trabalho • Uso elegante</p>
    ...
    <div class="bloco">
      ...
      <div class="notas">
        ...
        <div class="nota"><img src="/perfumatch/uploads/notas/cashmeran.png"><span>Cashmere</span></div>
      </div>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Amadeirado limpo e moderno, transmite elegância discreta e sensação de roupa recém-lavada.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Prada L’Homme</li>
        <li>Bleu de Chanel</li>
      </ul>

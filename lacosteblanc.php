...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Lacoste Blanc</h2>

  <div class="perfume-detalhe">

    <!-- ESQUERDA -->
    <div class="bloco">
      <img class="logo-marca" src="/perfumatch/uploads/marcas/lacoste.png">
      <img class="img-perfume" src="/perfumatch/uploads/Lacoste Blanc.jfif">
    ...
    <div class="bloco">
      ...
      <h4>Coração</h4>
      <div class="notas">
        <div class="nota"><img src="/perfumatch/uploads/notas/ylang.png"><span>Ylang Ylang</span></div>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Fresco limpo e elegante, transmite sensação de roupa branca e leveza.
      </p>

...
// PERFUME
$perfume_nome = "Acqua di Giò Profumo";
...
<head>
<meta charset="UTF-8">
<title>Acqua di Giò Profumo</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Acqua di Giò Profumo</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/aquaprofumo.jfif">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Dia e noite • Elegante</p>
    ...
    <div class="bloco">
      ...
      <div class="notas">
        ...
        <div class="nota"><img src="/perfumatch/uploads/notas/notasoceanicas.png"><span>Notas Marinhas</span></div>
      </div>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Aquático com incenso, transmite sofisticação e profundidade elegante.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Acqua di Giò Profondo</li>
        <li>Dior Sauvage EDP</li>
      </ul>

...
<meta charset="UTF-8">
<title>Perfumes Nacionais</title>
...
<h2 class="titulo-centro">Perfumes Nacionais</h2>

<div class="perfume-grid">

<?php

$sql = "SELECT * FROM perfumes WHERE tipo='nacional'";
...
<div class="sem-resultados">
    😢 Nenhum perfume Nacional encontrado
</div>

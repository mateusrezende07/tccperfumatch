...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Le Male Elixir</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/le male elixir.png">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Noite • Encontros • Balada • Clima frio</p>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        O Le Male Elixir transmite intensidade extrema, doçura envolvente e uma aura luxuosa e sedutora, sendo um perfume marcante e irresistível para noites frias.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Rayhaan Elixir</li>
        <li>Lion Hurt Man da Armaf </li>
      </ul>

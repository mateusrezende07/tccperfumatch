...
// PERFUME
$perfume_nome = "Terre d’Hermès Parfum";
...
<head>
<meta charset="UTF-8">
<title>Terre d’Hermès Parfum</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Terre d’Hermès Parfum</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/terreparfum.jfif">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Dia e noite • Trabalho • Eventos elegantes • Clima ameno/frio</p>
    ...
    <div class="bloco">
      ...
      <h3>Preço</h3>
      <div class="preco">R$ 750 – R$ 1200</div>
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        O Terre d’Hermès Parfum transmite força, elegância e maturidade, com um perfil mais denso e amadeirado, equilibrado por cítricos refinados — como um homem sofisticado, seguro e marcante.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Terre Parfum Inspired</li>
        <li>Wood Essence Premium</li>
      </ul>

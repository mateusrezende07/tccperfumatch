...
// PERFUME
$perfume_nome = "Stronger With You EDT";
...
<head>
<meta charset="UTF-8">
<title>Stronger With You EDT</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Stronger With You EDT</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/swy.jfif">
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Doce quente com baunilha e especiarias, transmite conforto e sensualidade.
      </p>

...
// PERFUME
$perfume_nome = "Givenchy Gentleman Reserve Privee";
...
<head>
<meta charset="UTF-8">
<title>Givenchy Gentleman Reserve Privee</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Givenchy Gentleman Reserve Privee</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Givenchy Gentleman Reserve Privée.jfif">
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Íris com whisky, transmite luxo e sofisticação intensa.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Dior Homme Intense</li>

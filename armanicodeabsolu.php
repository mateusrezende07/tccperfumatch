...
// PERFUME
$perfume_nome = "Armani Code Absolu";
...
<head>
<meta charset="UTF-8">
<title>Armani Code Absolu</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Armani Code Absolu</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Armani Code Absolu.jfif">
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Doce quente e envolvente, transmite sensualidade e conforto.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Armani Code Profumo</li>
        <li>The Most Wanted Parfum</li>
      </ul>

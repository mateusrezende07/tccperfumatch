...
// PERFUME
$perfume_nome = "Versace Eros Energy";
...
<head>
<meta charset="UTF-8">
<title>Versace Eros Energy</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Versace Eros Energy</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/versaceenegy.jfif">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Dia • Verão • Academia</p>
        <p><strong>Fixação:</strong> 6–8h</p>
        <p><strong>Projeção:</strong> 1–2 horas moderada</p>
    ...
    <div class="bloco">
      ...
      <div class="notas">
        ...
        <div class="nota"><img src="/perfumatch/uploads/notas/lima.png"><span>Lima</span></div>
      </div>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Cítrico vibrante e energético, transmite frescor, leveza e sensação revigorante.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Allure Homme Sport</li>

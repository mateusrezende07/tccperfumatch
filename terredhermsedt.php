...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Terre d’Hermès</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Terre d’Hermès EDT.jfif">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Dia • Trabalho • Ambientes formais • Uso elegante • Clima ameno</p>
    ...
    <div class="bloco">
      ...
      <h3>Preço</h3>
      <div class="preco">R$ 650 – R$ 1000</div>
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        O Terre d’Hermès transmite elegância natural, maturidade e sofisticação terrosa, com uma presença marcante e refinada — como um homem confiante, conectado à natureza e ao luxo discreto.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Terra Essence</li>
        <li>Woody Signature</li>
      </ul>

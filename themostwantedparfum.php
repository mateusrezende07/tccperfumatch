...
// PERFUME
$perfume_nome = "The Most Wanted Parfum";
...
<head>
<meta charset="UTF-8">
<title>The Most Wanted Parfum</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">The Most Wanted Parfum</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/the most wanted parfum.jfif">
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Doce intenso e envolvente, transmite sedução e presença forte.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>The Most Wanted Intense</li>

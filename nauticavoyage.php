...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Nautica Voyage</h2>

  <div class="perfume-detalhe">

    <!-- ESQUERDA -->
    <div class="bloco">
      <img class="logo-marca" src="/perfumatch/uploads/marcas/nautica.png">
      <img class="img-perfume" src="/perfumatch/uploads/Nautica Voyage.jfif">
    ...
    <div class="bloco">
      ...
      <div class="notas">
        ...
        <div class="nota"><img src="/perfumatch/uploads/notas/notasverdes.png"><span>Folhas Verdes</span></div>
      </div>
    ...
    <div class="bloco">
      ...
      <h3>Preço</h3>
      <div class="preco">R$ 150 – R$ 300</div>
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Fresco aquático leve, transmite sensação de brisa marítima e limpeza.
      </p>

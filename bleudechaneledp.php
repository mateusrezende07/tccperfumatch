...
// PERFUME
$perfume_nome = "Bleu de Chanel EDP";
...
<head>
<meta charset="UTF-8">
<title>Bleu de Chanel EDP</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Bleu de Chanel EDP</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Bleu de Chanel EDP.jpg">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Noite • Eventos</p>
        <p><strong>Fixação:</strong> 8–10h</p>
        <p><strong>Projeção:</strong> 2–3h</p>
    ...
    <div class="bloco">
      ...
      <div class="notas">
        ...
        <div class="nota"><img src="/perfumatch/uploads/notas/madeiraambar.png"><span>Madeira de Âmbar</span></div>
    ...
    <div class="bloco">
      <h3>Preço</h3>
      <div class="preco">R$ 750 – R$ 1100</div>
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
      O Bleu de Chanel Eau de Parfum transmite confiança forte, elegância madura e um leve mistério, com uma presença marcante e sofisticada.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Club de Nuit Iconic</li>
        <li>Like a Boss</li>
      </ul>
    </div>

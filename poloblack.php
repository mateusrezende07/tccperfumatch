...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Polo Black</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/poloblack.jfif">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Noite • Casual elegante</p>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Frutado amadeirado elegante, transmite sofisticação leve.
      </p>

...
// PERFUME
$perfume_nome = "Valentino Uomo Intense";
...
<head>
<meta charset="UTF-8">
<title>Valentino Uomo Intense</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Valentino Uomo Intense</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Valentino Uomo Intense.webp">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Noite • Encontros • Eventos elegantes • Clima frio</p>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        O Valentino Uomo Intense transmite elegância profunda, sensualidade cremosa e sofisticação marcante, com uma aura quente e envolvente — perfeito para noites frias.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Essence Intense</li>
        <li>Black Code Style</li>
      </ul>

...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Prada Luna Rossa</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Prada Luna Rossa.webp">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Dia • Trabalho • Academia • Uso casual • Clima quente</p>
        <p><strong>Fixação:</strong> 5–7h</p>
        <p><strong>Projeção:</strong> 1–2h</p>
    ...
    <div class="bloco">
      ...
      <div class="notas">
        ...
        <div class="nota"><img src="/perfumatch/uploads/notas/laranjaamarga.png"><span>Laranja Amarga</span></div>
      </div>
    ...
    <div class="bloco">
      ...
      <h3>Preço</h3>
      <div class="preco">R$ 500 – R$ 750</div>
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Refrescante, limpo e energético, com um toque aromático moderno — perfeito para o dia a dia e clima quente.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Luna Rossa Carbon</li>

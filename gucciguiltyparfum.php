...
// PERFUME
$perfume_nome = "Gucci Guilty Parfum";
...
<head>
<meta charset="UTF-8">
<title>Gucci Guilty Parfum</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Gucci Guilty Parfum</h2>

  <div class="perfume-detalhe">

    <!-- ESQUERDA -->
    <div class="bloco">
      <img class="logo-marca" src="/perfumatch/uploads/marcas/gucci.png">
      <img class="img-perfume" src="/perfumatch/uploads/gucci guilty parfum.png">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Noite</p>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Amadeirado aromático elegante, transmite masculinidade refinada.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Prada Luna Rossa Carbon</li>
        <li>Dior Sauvage EDT</li>
      </ul>

...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Dior Sauvage EDT</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Dior Sauvage EDT.jfif">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Dia e noite • Versátil</p>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Fresco apimentado moderno, transmite limpeza, masculinidade e presença marcante.
      </p>

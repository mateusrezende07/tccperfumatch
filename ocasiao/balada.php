...
<meta charset="UTF-8">
<title>Perfumes para Balada</title>
...
<h2 class="titulo-centro">Perfumes para Balada</h2>

<div class="perfume-grid">

<?php

$sql = "SELECT * FROM perfumes WHERE FIND_IN_SET('balada', ocasiao)";
...
<div class="sem-resultados">
    😢 Nenhum perfume encontrado para Balada
</div>

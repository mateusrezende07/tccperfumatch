...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Versace Eros EDP</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Eros EDP.webp">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Noite • Festas</p>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Doce fresco com hortelã e baunilha, transmite sensualidade e energia.
      </p>

...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Polo Deep Blue</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/ralph lauren polo deep blue.jfif">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Dia • Calor • Praia</p>
    ...
    <div class="bloco">
      ...
      <h4>Topo</h4>
      <div class="notas">
        <div class="nota"><img src="/perfumatch/uploads/notas/manga.png"><span>Manga</span></div>
      ...
      <h4>Coração</h4>
      <div class="notas">
        <div class="nota"><img src="/perfumatch/uploads/notas/cipreste.png"><span>Cipreste</span></div>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Aquático moderno e energético, transmite frescor oceânico intenso.
      </p>

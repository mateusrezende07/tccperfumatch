...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Invictus</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Invictus EDT.jfif">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Dia • Academia</p>
    ...
    <div class="bloco">
      ...
      <h4>Coração</h4>
      <div class="notas">
        <div class="nota"><img src="/perfumatch/uploads/notas/louro.png"><span>Louro</span></div>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Fresco doce esportivo, transmite energia e vitória.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Invictus Legend</li>
        <li>Invictus Victory</li>
      </ul>

...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Polo Red</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/polored.jfif">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Dia e noite • Casual</p>
    ...
    <div class="bloco">
      ...
      <div class="notas">
        ...
        <div class="nota"><img src="/perfumatch/uploads/notas/cranberry.png"><span>Cranberry</span></div>
      </div>
      ...
      <h4>Base</h4>
      <div class="notas">
        <div class="nota"><img src="/perfumatch/uploads/notas/cafe.png"><span>Café</span></div>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Fresco adocicado com café, transmite energia e atitude.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Polo Red Extreme</li>
        <li>Polo Black</li>
      </ul>

...
// PERFUME
$perfume_nome = "Armani Code Parfum";
...
<head>
<meta charset="UTF-8">
<title>Armani Code Parfum</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Armani Code Parfum</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/armanicodeparfum.webp">
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Amadeirado elegante com toque limpo, transmite sofisticação moderna.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Armani Code EDT</li>

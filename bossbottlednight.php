...
// PERFUME
$perfume_nome = "Boss Bottled Night";
...
<head>
<meta charset="UTF-8">
<title>Boss Bottled Night</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Boss Bottled Night</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/bossbottlednight.jfif">
    ...
    <div class="bloco">
      ...
      <div class="notas">
        ...
        <div class="nota"><img src="/perfumatch/uploads/notas/betula.png"><span>Bétula</span></div>
      </div>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Amadeirado aromático elegante, transmite sofisticação discreta.
      </p>

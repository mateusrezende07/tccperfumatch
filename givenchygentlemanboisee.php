...
// PERFUME
$perfume_nome = "Givenchy Gentleman Boisée";
...
<head>
<meta charset="UTF-8">
<title>Givenchy Gentleman Boisée</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Givenchy Gentleman Boisée</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Givenchy Gentleman Boisee.jfif">
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Amadeirado doce com íris, transmite elegância sofisticada.
      </p>

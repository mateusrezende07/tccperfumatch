...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Dior Sauvage EDP</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Dior Sauvage EDP.jfif">
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Mais doce e envolvente que o EDT, transmite sensualidade e elegância moderna.
      </p>

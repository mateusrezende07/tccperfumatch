...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Prada L’Homme</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Prada L’Homme.jfif">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Dia • Trabalho • Escritório • Ambientes formais • Uso elegante</p>
    ...
    <div class="bloco">
      ...
      <div class="notas">
        ...
        <div class="nota"><img src="/perfumatch/uploads/notas/cenoura.png"><span>Cenoura</span></div>
      </div>
      ...
      <div class="notas">
        ...
        <div class="nota"><img src="/perfumatch/uploads/notas/mate.png"><span>Mate</span></div>
      </div>
    ...
    <div class="bloco">
      ...
      <h3>Preço</h3>
      <div class="preco">R$ 650 – R$ 950</div>
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        O Prada L’Homme transmite elegância limpa, sofisticação e conforto, com uma vibe refinada e profissional — como alguém bem vestido em um ambiente de alto nível.
      </p>

...
// PERFUME
$perfume_nome = "Acqua di Giò Elixir";
...
<head>
<meta charset="UTF-8">
<title>Acqua di Giò Elixir</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Acqua di Giò Elixir</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/aquaelixir.jfif">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Noite • Elegante</p>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Aquático mais encorpado e sofisticado, transmite luxo e presença.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Acqua di Giò Profumo</li>
        <li>Bleu de Chanel Parfum</li>
      </ul>

...
<meta charset="UTF-8">
<title>Perfumes para Reunião</title>
...
<h2 class="titulo-centro">Perfumes para Reunião</h2>

<div class="perfume-grid">

<?php

$sql = "SELECT * FROM perfumes WHERE FIND_IN_SET('reuniao', ocasiao)";
...
<div class="sem-resultados">
    😢 Nenhum perfume encontrado para Reunião
</div>

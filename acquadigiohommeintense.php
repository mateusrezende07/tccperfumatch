...
// PERFUME
$perfume_nome = "Acqua di Giò Intense";
...
<head>
<meta charset="UTF-8">
<title>Acqua di Giò Intense</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Acqua di Giò Intense</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/adgedpintense.jfif">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Dia • Calor • Versátil</p>
    ...
    <div class="bloco">
      ...
      <h4>Topo</h4>
      <div class="notas">
        <div class="nota"><img src="/perfumatch/uploads/notas/maca.png"><span>Maçã Verde</span></div>
        <div class="nota"><img src="/perfumatch/uploads/notas/bergamota.png"><span>Bergamota da Calábria</span></div>
      </div>
    ...
    <div class="bloco">
      ...
      <h3>Preço</h3>
      <div class="preco">R$ 800 – R$ 1100</div>
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Fresco aquático moderno com toque frutado e amadeirado, transmite limpeza, energia e sofisticação leve.
      </p>

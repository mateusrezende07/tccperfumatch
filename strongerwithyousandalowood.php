...
// PERFUME
$perfume_nome = "Stronger With You Sandalwood";
...
<head>
<meta charset="UTF-8">
<title>Stronger With You Sandalwood</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Stronger With You Sandalwood</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/swysandalowood.jfif">
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Doce cremoso com sândalo, transmite conforto e sofisticação quente.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Stronger With You Intensely</li>
        <li>Armani Code Parfum</li>
      </ul>

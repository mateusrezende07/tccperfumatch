...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Bad Boy Cobalt</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Bad Boy Cobalt.jfif">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Dia • Noite</p>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Fresco mineral moderno, transmite energia e elegância.
      </p>

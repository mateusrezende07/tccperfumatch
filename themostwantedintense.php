...
// PERFUME
$perfume_nome = "Azzaro The Most Wanted Intense";
...
<head>
<meta charset="UTF-8">
<title>Azzaro The Most Wanted Intense</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Azzaro The Most Wanted Intense</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/the most wanted intense.webp">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Noite • Encontros • Balada</p>
        <p><strong>Fixação:</strong> 8–10h</p>
        <p><strong>Projeção:</strong> 2–3 horas forte</p>
    ...
    <div class="bloco">
      ...
      <div class="notas">
        <div class="nota"><img src="/perfumatch/uploads/notas/ambar.png"><span>Âmbar</span></div>
         <div class="nota"><img src="/perfumatch/uploads/notas/whisky.png"><span>whisky</span></div>
      </div>
    </div>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Doce quente e envolvente com toque especiado, transmite sedução, intensidade e confiança.
      </p>

...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Phantom Parfum</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/phantom parfum.jfif">
    ...
    <div class="bloco">
      ...
      <div class="notas">
        ...
        <div class="nota"><img src="/perfumatch/uploads/notas/ruibarbo.png"><span>Ruibarbo</span></div>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Mais intenso e cremoso, transmite modernidade e presença.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Phantom</li>
        <li>Phantom Intense</li>
      </ul>

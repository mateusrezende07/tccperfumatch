...
// PERFUME
$perfume_nome = "Givenchy Gentleman EDP";
...
<head>
<meta charset="UTF-8">
<title>Givenchy Gentleman EDP</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Givenchy Gentleman EDP</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Gentleman EDP.webp">
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Lavanda com baunilha e especiarias, transmite sofisticação e conforto.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Dior Homme Intense</li>
        <li>Valentino Uomo</li>
      </ul>

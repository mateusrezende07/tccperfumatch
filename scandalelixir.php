...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Scandal Elixir</h2>

  <div class="perfume-detalhe">

    <!-- ESQUERDA -->
    <div class="bloco">
      <img class="logo-marca" src="/perfumatch/uploads/marcas/jpg.png">
      <img class="img-perfume" src="/perfumatch/uploads/scandalelixir.jfif">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Noite • Balada • Encontros</p>
        <p><strong>Fixação:</strong> 10–12h</p>
        <p><strong>Projeção:</strong> 3 horas média</p>
    ...
    <div class="bloco">
      ...
      <h4>Topo</h4>
      <div class="notas">
        <div class="nota"><img src="/perfumatch/uploads/notas/cereja.png"><span>Cereja Preta</span></div>
        <div class="nota"><img src="/perfumatch/uploads/notas/bergamota.png"><span>Bergamota</span></div>
        <div class="nota"><img src="/perfumatch/uploads/notas/salvia.png"><span>Sálvia Esclaréia</span></div>
      ...
      <div class="notas">
        ...
        <div class="nota"><img src="/perfumatch/uploads/notas/rum.png"><span>Rum</span></div>
        <div class="nota"><img src="/perfumatch/uploads/notas/geranio.png"><span>Gerânio</span></div>
      ...
      <div class="notas">
        ...
        <div class="nota"><img src="/perfumatch/uploads/notas/oud.png"><span>Akigalawood</span></div>
      </div>
    </div>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Doce frutado com cereja e rum, envolvido por baunilha e notas amadeiradas, transmite ousadia, sensualidade e presença marcante.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Stronger With You Intensely</li>
        <li>1 Million Elixir</li>
      </ul>

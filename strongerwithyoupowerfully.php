...
// PERFUME
$perfume_nome = "Stronger With You Powerfully";
...
<head>
<meta charset="UTF-8">
<title>Stronger With You Powerfully</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Stronger With You Powerfully</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/swyporwerfully.jfif">
    ...
    <div class="bloco">
      ...
      <h4>Topo</h4>
      <div class="notas">
        <div class="nota"><img src="/perfumatch/uploads/notas/cereja.png"><span>Cereja</span></div>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Doce frutado com cereja envolto por especiarias e baunilha, transmite intensidade, calor e sensualidade moderna.
      </p>

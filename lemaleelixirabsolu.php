...
// PERFUME
$perfume_nome = "Le Male Elixir Absolu";
...
<head>
<meta charset="UTF-8">
<title>Le Male Elixir Absolu</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Le Male Elixir Absolu</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Le Male Elixir Absolu.jfif">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Noite • Balada • Encontros</p>
        <p><strong>Fixação:</strong> 12h+</p>
        <p><strong>Projeção:</strong> 3–4 horas forte</p>
    ...
    <div class="bloco">
      ...
      <h4>Topo</h4>
      <div class="notas">
        <div class="nota"><img src="/perfumatch/uploads/notas/ameixa.png"><span>Ameixa</span></div>
      ...
      <div class="notas">
        ...
        <div class="nota"><img src="/perfumatch/uploads/notas/davana.png"><span>Davana</span></div>
      ...
      <div class="notas">
        ...
        <div class="nota"><img src="/perfumatch/uploads/notas/ambreta.png"><span>Ambreta</span></div>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Doce intenso e especiado com toque licoroso de ameixa, transmite sedução, poder e presença marcante.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Stronger With You Absolutely</li>
        <li>Ultra Male</li>
      </ul>

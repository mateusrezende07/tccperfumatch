...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Polo Green</h2>

  <div class="perfume-detalhe">

    <!-- ESQUERDA -->
    <div class="bloco">
      <img class="logo-marca" src="/perfumatch/uploads/marcas/ralphlauren.png">
      <img class="img-perfume" src="/perfumatch/uploads/pologreen.jfif">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Dia • Clássico</p>
    ...
    <div class="bloco">
      ...
      <h4>Topo</h4>
      <div class="notas">
        <div class="nota"><img src="/perfumatch/uploads/notas/zimbro.png"><span>Zimbro</span></div>
      ...
      <h4>Coração</h4>
      <div class="notas">
        <div class="nota"><img src="/perfumatch/uploads/notas/pinheiro.png"><span>Pinheiro</span></div>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Verde clássico e elegante, transmite tradição e masculinidade forte.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Polo Cologne Intense</li>
        <li>Polo Oud</li>
      </ul>

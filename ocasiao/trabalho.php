...
<meta charset="UTF-8">
<title>Perfumes para Trabalho</title>
...
<h2 class="titulo-centro">Perfumes para Trabalho</h2>

<div class="perfume-grid">

<?php

$sql = "SELECT * FROM perfumes WHERE FIND_IN_SET('trabalho', ocasiao)";
...
<div class="sem-resultados">
    😢 Nenhum perfume encontrado para Trabalho
</div>

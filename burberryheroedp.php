...
// PERFUME
$perfume_nome = "Burberry Hero EDP";
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Burberry Hero EDP</h2>

  <div class="perfume-detalhe">

    <!-- ESQUERDA -->
    <div class="bloco">
      <img class="logo-marca" src="/perfumatch/uploads/marcas/burberry.png">
      <img class="img-perfume" src="/perfumatch/uploads/Burberry Hero EDP.jfif">
    ...
    <div class="bloco">
      ...
      <h3>Preço</h3>
      <div class="preco">R$ 900 – R$ 1200</div>
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Amadeirado mais intenso, transmite presença e sofisticação.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Burberry Hero EDT</li>

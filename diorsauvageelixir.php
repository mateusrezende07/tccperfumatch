...
// PERFUME
$perfume_nome = "Dior Sauvage Elixir";
...
<head>
<meta charset="UTF-8">
<title>Dior Sauvage Elixir</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Dior Sauvage Elixir</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Dior Sauvage Elixir.jfif">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Noite • Frio • Eventos</p>
    ...
    <div class="bloco">
      ...
      <div class="notas">
        ...
        <div class="nota"><img src="/perfumatch/uploads/notas/alcacuz.png"><span>Alcaçuz</span></div>
    ...
    <div class="bloco">
      ...
      <h3>Preço</h3>
      <div class="preco">R$ 1100 – R$ 1500</div>
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Extremamente intenso e especiado, transmite poder, sofisticação e presença dominante.
      </p>

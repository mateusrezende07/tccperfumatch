...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Polo Blue</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Ralph Lauren Polo Blue.jfif">
    ...
    <div class="bloco">
      ...
      <div class="notas">
        ...
        <div class="nota"><img src="/perfumatch/uploads/notas/pepino.png"><span>Pepino</span></div>
        <div class="nota"><img src="/perfumatch/uploads/notas/mandarina.png"><span>Mandarina</span></div>
      </div>

      <h4>Coração</h4>
      <div class="notas">
        <div class="nota"><img src="/perfumatch/uploads/notas/manjericao.png"><span>Manjericão</span></div>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Fresco aquático leve, transmite liberdade e sensação de céu aberto.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Polo Deep Blue</li>

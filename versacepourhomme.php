...
// PERFUME
$perfume_nome = "Versace Pour Homme";
...
<head>
<meta charset="UTF-8">
<title>Versace Pour Homme</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Versace Pour Homme</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Versace Pour Homme.jfif">
    ...
    <div class="bloco">
      ...
      <h4>Coração</h4>
      <div class="notas">
        <div class="nota"><img src="/perfumatch/uploads/notas/jacinto.png"><span>Jacinto</span></div>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Fresco cítrico limpo, transmite sensação de banho e elegância leve.
      </p>

...
// PERFUME
$perfume_nome = "Versace Eros Flame";
...
<head>
<meta charset="UTF-8">
<title>Versace Eros Flame</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Versace Eros Flame</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Eros Flame.jfif">
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Cítrico quente com baunilha, transmite paixão e intensidade.
      </p>

...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Ultra Male</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <h4>Topo</h4>
      <div class="notas">
        <div class="nota"><img src="/perfumatch/uploads/notas/pera.png"><span>Pera</span></div>
    ...
    <div class="bloco">
      ...
      <h3>Preço</h3>
      <div class="preco">R$ 600 – R$ 1000</div>
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        O Ultra Male transmite uma sensação doce, frutada e extremamente sedutora, com uma presença forte e chamativa que se destaca facilmente em ambientes noturnos.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Attar Al Wesal</li>
        <li> Afnan 9PM</li>
        <li> Lion Rayhaan</li>
      </ul>

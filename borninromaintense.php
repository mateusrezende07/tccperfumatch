...
// PERFUME
$perfume_nome = "Valentino Uomo Born in Roma Intense";
...
<head>
<meta charset="UTF-8">
<title>Valentino Uomo Born in Roma Intense</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Valentino Uomo Born in Roma Intense</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/borninromaintense.jfif">
    ...
    <div class="bloco">
      ...
      <h3>Preço</h3>
      <div class="preco">R$ 750 – R$ 1150</div>
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
       O Valentino Uomo Born in Roma Intense transmite sensualidade quente, intensidade e confiança envolvente, com uma presença marcante e sedutora — como uma noite elegante cheia de atitude.
      </p>

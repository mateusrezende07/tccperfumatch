...
// PERFUME
$perfume_nome = "Montblanc Legend Spirit";
...
<head>
<meta charset="UTF-8">
<title>Montblanc Legend Spirit</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Montblanc Legend Spirit</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Montblanc Legend Spirit.jfif">
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Fresco aquático limpo, transmite leveza e sensação refrescante.
      </p>

...
// PERFUME
$perfume_nome = "Bvlgari Man in Black Parfum";
...
<head>
<meta charset="UTF-8">
<title>Bvlgari Man in Black Parfum</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Bvlgari Man in Black Parfum</h2>

  <div class="perfume-detalhe">

    <!-- ESQUERDA -->
    <div class="bloco">
      <img class="logo-marca" src="/perfumatch/uploads/marcas/bvlgari.png">
      <img class="img-perfume" src="/perfumatch/uploads/bvgari.jfif">
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Mais intenso e refinado, transmite luxo, calor e presença marcante.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Man in Black EDP</li>

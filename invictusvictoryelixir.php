...
// PERFUME
$perfume_nome = "Invictus Victory Elixir";
...
<head>
<meta charset="UTF-8">
<title>Invictus Victory Elixir</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Invictus Victory Elixir</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Invictus Victory Elixir.jfif">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Noite • Balada • Encontros • Clima frio</p>
        <p><strong>Fixação:</strong> 12h+</p>
        <p><strong>Projeção:</strong> 3h forte</p>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        O Invictus Victory Elixir transmite uma sensação extremamente intensa, doce e poderosa, com uma presença dominante e marcante, ideal para quem quer impor respeito e destaque.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Victory Gold Essence</li>
        <li>Power Night Elixir</li>
      </ul>

...
// PERFUME
$perfume_nome = "Burberry Hero EDT";
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Burberry Hero EDT</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Burberry Hero EDT.jfif">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Dia • Moderno</p>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Amadeirado fresco, transmite liberdade e elegância moderna.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Burberry Hero EDP</li>

...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">CH Men</h2>

  <div class="perfume-detalhe">

    <!-- ESQUERDA -->
    <div class="bloco">
      <img class="logo-marca" src="/perfumatch/uploads/marcas/carolinaherrera.png">
      <img class="img-perfume" src="/perfumatch/uploads/chmen.jfif">
    ...
    <div class="bloco">
      ...
      <h4>Topo</h4>
      <div class="notas">
        <div class="nota"><img src="/perfumatch/uploads/notas/grama.png"><span>Grama</span></div>
      ...
      <h4>Base</h4>
      <div class="notas">
        <div class="nota"><img src="/perfumatch/uploads/notas/acucar.png"><span>Açúcar</span></div>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Doce com couro e açúcar, transmite elegância e conforto.
      </p>

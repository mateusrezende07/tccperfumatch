...
// PERFUME
$perfume_nome = "Prada Luna Rossa Ocean";
...
<head>
<meta charset="UTF-8">
<title>Prada Luna Rossa Ocean</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Prada Luna Rossa Ocean</h2>

  <div class="perfume-detalhe">

    <!-- ESQUERDA -->
    <div class="bloco">
      <img class="logo-marca" src="/perfumatch/uploads/marcas/prada.png">
      <img class="img-perfume" src="/perfumatch/uploads/Prada Luna Rossa Ocean.jfif">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Dia • Trabalho • Casual • Calor</p>
    ...
    <div class="bloco">
      ...
      <div class="notas">
        ...
        <div class="nota"><img src="/perfumatch/uploads/notas/pimentarosa.png"><span>Pimenta Rosa</span></div>
        <div class="nota"><img src="/perfumatch/uploads/notas/artemisia.png"><span>Artemísia</span></div>
      </div>
      ...
      <div class="notas">
        ...
        <div class="nota"><img src="/perfumatch/uploads/notas/salvia.png"><span>Sálvia</span></div>
        <div class="nota"><img src="/perfumatch/uploads/notas/camurca.png"><span>Camurça</span></div>
      ...
      <div class="notas">
        ...
        <div class="nota"><img src="/perfumatch/uploads/notas/caramelo.png"><span>Caramelo</span></div>
        <div class="nota"><img src="/perfumatch/uploads/notas/vetiver.png"><span>Vetiver do Haiti</span></div>
        <div class="nota"><img src="/perfumatch/uploads/notas/patchouli.png"><span>Patchouli</span></div>
      </div>
    </div>
    ...
    <div class="bloco">
      ...
      <h3>Preço</h3>
      <div class="preco">R$ 550 – R$ 850</div>
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Fresco moderno com toque aquático e levemente adocicado, elegante e versátil para o dia a dia.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Bleu de Chanel EDT</li>
        <li>Acqua di Gio Profondo</li>
      </ul>

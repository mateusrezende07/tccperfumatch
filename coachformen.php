...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Coach for Men</h2>

  <div class="perfume-detalhe">

    <!-- ESQUERDA -->
    <div class="bloco">
      <img class="logo-marca" src="/perfumatch/uploads/marcas/coach.png">
      <img class="img-perfume" src="/perfumatch/uploads/Coach for Men.jfif">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Dia • Casual</p>
    ...
    <div class="bloco">
      ...
      <div class="notas">
        ...
        <div class="nota"><img src="/perfumatch/uploads/notas/quinca.png"><span>Quincã</span></div>
      </div>
    ...
    <div class="bloco">
      ...
      <h3>Preço</h3>
      <div class="preco">R$ 300 – R$ 600</div>
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Fresco frutado leve, transmite juventude e leveza.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Coach Blue</li>
        <li>Montblanc Legend Spirit</li>
      </ul>

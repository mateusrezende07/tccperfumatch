...
// PERFUME
$perfume_nome = "The One For Men EDP";
...
<head>
<meta charset="UTF-8">
<title>The One For Men EDP</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">The One For Men EDP</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/The One EDP.jfif">
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Doce especiado elegante, transmite charme e sedução clássica.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>La Nuit de L'Homme</li>
        <li>Spicebomb</li>
      </ul>

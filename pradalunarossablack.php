...
// PERFUME
$perfume_nome = "Prada Luna Rossa Black";
...
<head>
<meta charset="UTF-8">
<title>Prada Luna Rossa Black</title>
...
<h2 class="titulo-centro">Prada Luna Rossa Black</h2>
...
<div class="perfume-detalhe">
  ...
  <div class="bloco">
    ...
    <img class="img-perfume" src="/perfumatch/uploads/Prada Luna Rossa Black.jfif">

    <div class="info">
      <p><strong>Gênero:</strong> Masculino</p>
      <p><strong>Ocasião:</strong> Noite • Balada • Encontros • Frio</p>
  ...
  <div class="bloco">
    ...
    <h4>Coração</h4>
    <div class="notas">
      <div class="nota"><img src="/perfumatch/uploads/notas/angelica.png"><span>Angélica</span></div>
      <div class="nota"><img src="/perfumatch/uploads/notas/patchouli.png"><span>Patchouli</span></div>
    </div>

    <h4>Base</h4>
    <div class="notas">
      <div class="nota"><img src="/perfumatch/uploads/notas/cumarina.png"><span>Cumarina</span></div>
  ...
  <div class="bloco">
    ...
    <h3>Sensação</h3>
    <p class="sensacao">
      Doce, envolvente e misterioso, com um toque ambarado quente e elegante.
    </p>

    <h3>Inspirados</h3>
    <ul class="inspirados">
      <li>Armani Code Absolu</li>
      <li>The One EDP</li>
    </ul>

...
// PERFUME
$perfume_nome = "Narciso Rodriguez Bleu Noir";
...
<head>
<meta charset="UTF-8">
<title>Narciso Rodriguez Bleu Noir</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Narciso Rodriguez Bleu Noir</h2>

  <div class="perfume-detalhe">

    <!-- ESQUERDA -->
    <div class="bloco">
      <img class="logo-marca" src="/perfumatch/uploads/marcas/narcisorodriguez.png">
      <img class="img-perfume" src="/perfumatch/uploads/Narciso Rodriguez Bleu Noir.jfif">
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Almiscarado sofisticado, transmite elegância limpa e misteriosa.
      </p>

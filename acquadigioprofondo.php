...
// PERFUME
$perfume_nome = "Acqua di Giò Profondo";
...
<head>
<meta charset="UTF-8">
<title>Acqua di Giò Profondo</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Acqua di Giò Profondo</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Acqua di Giò Profondo.jfif">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Dia • Calor • Moderno</p>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Aquático profundo e moderno, transmite frescor oceânico com sofisticação.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Acqua di Giò Profumo</li>
        <li>Light Blue Intense</li>
      </ul>

...
// PERFUME
$perfume_nome = "Terre d’Hermès Eau Intense Vetiver";
...
<head>
<meta charset="UTF-8">
<title>Terre d’Hermès Eau Intense Vetiver</title>
...
<h2 class="titulo-centro">Terre d’Hermès Eau Intense Vetiver</h2>

<div class="perfume-detalhe">

  <!-- ESQUERDA -->
  <div class="bloco">
    <img class="logo-marca" src="/perfumatch/uploads/marcas/hermes.png">
    <img class="img-perfume" src="/perfumatch/uploads/terreintense.jfif">

    <div class="info">
      <p><strong>Gênero:</strong> Masculino</p>
      <p><strong>Ocasião:</strong> Dia • Trabalho • Uso elegante • Clima quente/ameno • Ambientes formais</p>
  ...
  <div class="bloco">
    ...
    <h4>Coração</h4>
    <div class="notas">
      <div class="nota"><img src="/perfumatch/uploads/notas/pimenta.png"><span>Pimenta de Sichuan</span></div>
    ...
    <div class="notas">
      ...
      <div class="nota"><img src="/perfumatch/uploads/notas/olibano.png"><span>Olíbano</span></div>
  ...
  <div class="bloco">
    ...
    <h3>Preço</h3>
    <div class="preco">R$ 700 – R$ 1100</div>
    ...
    <h3>Sensação</h3>
    <p class="sensacao">
      Elegância natural e sofisticação terrosa, com frescor cítrico equilibrado por notas amadeiradas — transmite confiança discreta e refinamento.
    </p>

    <h3>Inspirados</h3>
    <ul class="inspirados">
      <li>Terre Vetiver Inspired</li>
      <li>Essence Wood Vetiver</li>
    </ul>

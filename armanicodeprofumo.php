...
// PERFUME
$perfume_nome = "Armani Code Profumo";
...
<head>
<meta charset="UTF-8">
<title>Armani Code Profumo</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Armani Code Profumo</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/armani code profumo.jfif">
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Doce intenso e sedutor, transmite luxo e presença forte.
      </p>

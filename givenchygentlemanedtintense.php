...
// PERFUME
$perfume_nome = "Givenchy Gentleman EDT Intense";
...
<head>
<meta charset="UTF-8">
<title>Givenchy Gentleman EDT Intense</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Givenchy Gentleman EDT Intense</h2>

  <div class="perfume-detalhe">

    <!-- ESQUERDA -->
    <div class="bloco">
      <img class="logo-marca" src="/perfumatch/uploads/marcas/givenchy.png">
      <img class="img-perfume" src="/perfumatch/uploads/Givenchy Gentleman EDT Intense.jfif">
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Aromático com íris e especiarias, transmite elegância moderna.
      </p>

...
// PERFUME
$perfume_nome = "Bvlgari Man Wood Neroli";
...
<head>
<meta charset="UTF-8">
<title>Bvlgari Man Wood Neroli</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Bvlgari Man Wood Neroli</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Bvlgari Man Wood Neroli.jfif">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Dia • Calor • Elegante</p>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Fresco cítrico elegante, transmite sofisticação leve e natural.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Neroli Portofino</li>
        <li>Acqua di Gio</li>
      </ul>

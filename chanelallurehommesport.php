...
// PERFUME
$perfume_nome = "Chanel Allure Homme Sport";
...
<head>
<meta charset="UTF-8">
<title>Chanel Allure Homme Sport</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Chanel Allure Homme Sport</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Chanel Allure Homme Sport.jfif">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Dia • Academia • Verão • Casual</p>
    ...
    <div class="bloco">
      ...
      <div class="notas">
        ...
        <div class="nota"><img src="/perfumatch/uploads/notas/mandarinasanguinia.png"><span>Mandarina Sanguínea</span></div>
      </div>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
       O Allure Homme Sport transmite uma sensação de frescor sofisticado e limpeza elegante, trazendo leveza, energia e uma confiança natural no dia a dia.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Alpine Homme Sport</li>
        <li>Alfa</li>
        <li>Alummer</li>
      </ul>

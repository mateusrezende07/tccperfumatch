...
// PERFUME
$perfume_nome = "Stronger With You Absolutely";
...
<head>
<meta charset="UTF-8">
<title>Stronger With You Absolutely</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Stronger With You Absolutely</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Stronger With You Absolutely.jfif">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Noite • Frio</p>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Extremamente doce e alcoólico, transmite calor, intensidade e sedução.
      </p>

      <h3>Inspirados</h3>
      <ul class="inspirados">
        <li>Stronger With You Intensely</li>
        <li>Armani Code Profumo</li>
      </ul>

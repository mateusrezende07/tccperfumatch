...
// PERFUME
$perfume_nome = "Versace Eros Parfum";
...
<head>
<meta charset="UTF-8">
<title>Versace Eros Parfum</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Versace Eros Parfum</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/erosparfum.webp">
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Doce intenso e moderno, transmite poder e sensualidade.
      </p>

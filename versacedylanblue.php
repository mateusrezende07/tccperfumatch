...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Dylan Blue</h2>

  <div class="perfume-detalhe">

    <!-- ESQUERDA -->
    <div class="bloco">
      <img class="logo-marca" src="/perfumatch/uploads/marcas/versace.png">
      <img class="img-perfume" src="/perfumatch/uploads/Versace Dylan Blue.jfif">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Noite • Encontros</p>
    ...
    <div class="bloco">
      ...
      <div class="notas">
        ...
        <div class="nota"><img src="/perfumatch/uploads/notas/figo.png"><span>Figo</span></div>
      </div>
    ...
    <div class="bloco">
      ...
      <h3>Preço</h3>
      <div class="preco">R$ 500 – R$ 800</div>
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Fresco doce moderno, transmite sensualidade, limpeza e versatilidade.
      </p>

...
// PERFUME
$perfume_nome = "Dior Homme Sport 2021";
...
<head>
<meta charset="UTF-8">
<title>Dior Homme Sport 2021</title>
...
<div class="conteudo-principal">
  ...
  <h2 class="titulo-centro">Dior Homme Sport 2021</h2>
  ...
  <div class="perfume-detalhe">
    ...
    <div class="bloco">
      ...
      <img class="img-perfume" src="/perfumatch/uploads/Dior Homme Sport 2021.jpg">

      <div class="info">
        <p><strong>Gênero:</strong> Masculino</p>
        <p><strong>Ocasião:</strong> Dia • Calor • Casual</p>
    ...
    <div class="bloco">
      ...
      <div class="notas">
        ...
        <div class="nota"><img src="/perfumatch/uploads/notas/elemi.png"><span>Elemi</span></div>
      </div>
    ...
    <div class="bloco">
      ...
      <h3>Sensação</h3>
      <p class="sensacao">
        Cítrico fresco e energético com toque amadeirado, transmite vitalidade e limpeza.
      </p>
